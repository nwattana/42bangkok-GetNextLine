...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/06/02 18:50:56 by nwattana          #+#    #+#             */
/*   Updated: 2022/06/02 21:16:34 by nwattana         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_next_line(int fd)
{
	...
	g_buffer[fd] = read_file_fd(fd, g_buffer[fd]);
	line = get_line(g_buffer[fd]);
	g_buffer[fd] = update_g(g_buffer[fd], line);
	return (line);
}
